<?php
    ...
    $stmt = $conn->query("SELECT id, passenger_name, destination, fare, created_at 
        FROM bookings  
        ORDER BY id ASC");
    ...
    $average_fare = $booking_count > 0 ? $total_fare / $booking_count : 0; //Calculating the average value 
    $highest_fare = 0;
